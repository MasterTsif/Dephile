...
public class NPC_Sand extends Entity
{
	...
	{
		dialogues[0] = "0/4. I am bound to these waters, a prisoner of\nthe tide. No way out remains for one\nsuch as I.";
		dialogues[1] = "1/4. Beware, traveler, the shifting sands conspire\nto snare your steps. Time is your\nenemy.";
		dialogues[2] = "2/4. The keys, oh seeker of freedom—each one a\nfragment of hope. They hide in shadows,\nand one lies below.";
		dialogues[3] = "3/4. Should you find the key, tread carefully.\nDoors opened may lead not to escape,\nbut to deeper shadows.";
		dialogues[4] = "4/4. The waters may mend your wounds, yet they\ncradle no loyalty. They heal both the\njust and the wicked.";
	}
